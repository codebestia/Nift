...
export default function DashboardPage() {
  ...
  const {data: pointsData, isLoading: isLoadingPoints, isError: isErrorPoints} = useReadContract({
  ...
  const {data: purchasedGifts, isLoading: isLoadingPurchasedData, isError: isPurchasedDataPoints} = useReadContract({
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Overview of your gift card activity and stats.</p>
      </div>
      <Analytics
