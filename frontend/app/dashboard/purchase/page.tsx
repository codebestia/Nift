...
export default function PurchasePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Purchase a Gift Card</h1>
        <p className="text-muted-foreground">Create a new NFT gift card with your chosen cryptocurrency.</p>
      </div>
