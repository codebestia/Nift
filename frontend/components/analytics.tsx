...
export function Analytics({numberOfGiftsPurchased, numberOfGiftsRedeemed, numberofPoints}: AnalyticsType) {
  const data = [
    {
      date: "Jan 2023",
      purchased: 2,
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-card border border-purple-800/30">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl font-bold">{numberOfGiftsPurchased}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border border-purple-800/30">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl font-bold">{numberOfGiftsRedeemed}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="text-sm text-muted-foreground">+8.2% from last month</div>
        ...
        <Card className="bg-card border border-purple-800/30">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl font-bold">{numberofPoints}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between">
        ...
        <TabsContent value="activity" className="space-y-4">
          <Card className="border border-purple-800/30">
            <CardHeader>
              ...
              <CardDescription>Number of gift cards purchased and redeemed over time.</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="value" className="space-y-4">
          <Card className="border border-purple-800/30">
            <CardHeader>
              ...
              <CardDescription>Total value of gift cards purchased and redeemed over time.</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={valueData} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#333" />
                    <XAxis dataKey="date" stroke="#888" fontSize={12} tickLine={false} axisLine={false} />
                    <YAxis stroke="#888" fontSize={12} tickLine={false} axisLine={false} />
                    <Tooltip
                          ...
                          return (
                            <div className="rounded-lg border bg-background p-2 shadow-sm">
                              <div className="grid grid-cols-2 gap-2">
                                ...
                                <div className="flex flex-col">
                                  <span className="flex items-center gap-1 text-[0.70rem] uppercase text-muted-foreground">
                                    <div className="h-2 w-2 rounded-full bg-purple-500"></div>${payload[0].value}
                                  </span>
                                </div>
                              </div>
                            </div>
