      ...
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-zinc-400 mb-4">The future of digital gifting, powered by blockchain technology.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#features" className="text-zinc-400 hover:text-purple-400">
                  Features
                </Link>
              </li>
              <li>
                <Link href="#newsletter" className="text-zinc-400 hover:text-purple-400">
                  Newsletter
                </Link>
              </li>
              <li>
