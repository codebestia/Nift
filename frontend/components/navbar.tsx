      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="#newsletter" className="text-sm font-medium text-zinc-400 hover:text-white">
              Newsletter
            </Link>
            {isConnected && (
              <Link
      ...
      {isMenuOpen && (
        <div className="container md:hidden">
          <nav className="flex flex-col space-y-4 pb-4">
            ...
            <Link href="#features" className="text-sm font-medium text-zinc-400" onClick={() => setIsMenuOpen(false)}>
              Features
            </Link>
            <Link href="#newsletter" className="text-sm font-medium text-zinc-400" onClick={() => setIsMenuOpen(false)}>
              Newsletter
            </Link>
            {isWalletConnected && (
              <Link
